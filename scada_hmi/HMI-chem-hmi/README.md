...
Troubleshoot 2: Ensure that the pgsql/data/pg_hba.conf allows remote connection on all devices.
Troubleshoot 3: If remote systems ensure that the devices ip is in the listen_address in the pgsql/data/postgresql.conf file.
